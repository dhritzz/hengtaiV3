...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download hengtai..."
        sudo git clone https://github.com/dahlah270/hengtai.git > /dev/null 2>&1 || echo "[!] Could not download hengtai."
        cd hengtai > /dev/null 2>&1
        ...
        echo "[i] We will now install hengtai..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install hengtai."
        ...
        echo "[i] We will now download hengtai..."
        sudo git clone https://github.com/Taguar258/hengtai.git > /dev/null 2>&1  || echo "[!] Could not download hengtai."
        cd hengtai > /dev/null 2>&1
        echo "[i] We will now install requirements..."
        sudo pip3 install -r requirements.txt  > /dev/null 2>&1 || echo "[!] Could not install the requirements."
        echo "[i] We will now install hengtai..."
        ...
        git clone https://github.com/Taguar258/hengtai.git > /dev/null 2>&1 || echo "[!] Please install git"
        cd hengtai
